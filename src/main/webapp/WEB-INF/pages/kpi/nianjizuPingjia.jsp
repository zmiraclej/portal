...
<body class="hold-transition skin-blue-light sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper" style="background-color: white">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">年级组考核</a> <span class="divider"></span></li>
			</ul>
			</section>
			<!-- 中间部分-top     end -->
				...
				<form class="layui-form">
					<div class="layui-form-item">
						...
						<div class="layui-input-inline" style="width: 150px;">
							<select id="nianjizuCode" lay-filter="nianjizuCode">
								<option value="">请选择年级组</option>
	...
	<!-- 业务逻辑 -->
	<script src="js/pages/kpi/nianjizuPingjia.js"></script>
		...
		$(document).ready(
				function() {
					layui.use([ 'jquery', 'form', 'layedit' ], function() {
						...
						form.on('select(nianjizuCode)', function(data) {
							if ($("#kpiInsId").val() != ''
									&& $("#nianjizuCode").val() != '') {
								initTable();
								initYpTable();
