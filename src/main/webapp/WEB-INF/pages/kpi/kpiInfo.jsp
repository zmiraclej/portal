...
<body class="hold-transition skin-blue-light sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper" style="background-color: white">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">绩效考核总评</a> <span class="divider"></span></li>
			</ul>
			</section>
			<!-- 中间部分-top     end -->
			...
			<div class="page-content">
				<div id="toolbar" class="btn-group">
					...
					<div class="layui-input-inline">
						...
						<button id="exp" onclick="exp()" class="secBtnDes">
						<li class="btnIconCss">
	...
	<div id='editLayer' style="display: none;">
		<div style="height: 500px; width: 980px; float: left">
			<div id='pjTreeGrid' style="overflow: auto; margin-left: 5px; margin-top: 5px;"></div>
		</div>
		<div id='attachGrid' style="overflow: auto; width: 250px; margin-right: 5px; margin-top: 5px; float: right"></div>
	</div>
	...
	<!-- 业务逻辑 -->
	<script src="js/pages/kpi/kpiInfo.js"></script>
