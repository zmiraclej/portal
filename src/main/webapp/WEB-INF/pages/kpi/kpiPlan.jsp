...
<body class="hold-transition skin-blue-light sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper" style="background-color: white">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">预评分设定</a> <span class="divider"></span></li>
			</ul>
			</section>
			<!-- 中间部分-top     end -->
			...
			<div class="page-content">
				<div id="toolbar" class="btn-group">
					...
					<div class="layui-input-inline">
						...
						<li class="btnIconCss">
						<img src="img/newIcon/data_storage_16px_1196189_easyicon.net.png"></li>保存设定
						</button>
					</div>
				</div>
	...
	<!-- 业务逻辑 -->
	<script src="js/pages/kpi/kpiPlan.js"></script>
