...
<html lang="en">
<head>
    <title id="Description">部门查询</title>
			...
			<!-- 中间部分-main     startup -->
				<section class="content" style="margin-top:20px"> 
				    <table width="100%">
				    	<tr>
				    		<td width="300px">
					    		<div style="height:600px;width:300px;background-color:white;overflow-y:auto">
									 <div id="tree">
										 </div>
								</div>
				    		</td>
				    		<td>
				    			<div style="margin-left:10px;height:600px;background-color:white">
								 	<table id="employeeTable" data-toggle="table"
...
<script src="js/pages/hr/archives.js"></script>
</body>
