...
<body class="hold-transition skin-blue-light sidebar-mini">
    ...
    <div class="box">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">添加总分统计配置</h3>
            </div>
            <!-- form start -->
            <form id="form" class="form-horizontal" action="${ctx}/countsave" method="post" name="formDemo">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <textarea id="countName" name="countName" rows="5" maxlength="255" class="form-control"></textarea>
                  </div>
                </div>
                <div class="form-group">
              ...
              <div class="box-footer" style="text-align: center">
                ...
                <button id="formBtn" type="submit" class="btn  btn-primary">确定</button>
              </div>
            </form>
          </div>
          </div>
...
<script src="js/app.min.js"></script>
	<SCRIPT type="text/javascript">
		...
		$(document).ready(function(){
			...
			$("#recDate1").val(FormatDate(new Date()));
			$("#recDate2").val(FormatDate(new Date()));
