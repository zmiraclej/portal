...
<html lang="en">
<head>
<title id="Description">成绩上传管理</title>
...
<body class="hold-transition skin-blue-light sidebar-mini">
	...
	<div id="templatesToolbar" class="btn-group">
		...
		<div class="layui-btn-group" style="margin-left: 10px">
			...
			<button id="downLoadTemplateBtn" class="fristBtnDes">
				<li class="btnIconCss"><img
					src="img/newIcon/download_16px_1172411_easyicon.net.png"></li>下载模板
			</button>
		
			<button id="uploadScoreBtn" class="fristBtnDes">
				<li class="btnIconCss"><img
					src="img/newIcon/add_16px_1209048_easyicon.net.png"></li>上传成绩
			</button>
			
			<button id="deleteScoreBtn" class="fristBtnDes ">
				<li class="btnIconCss"><img
					src="img/newIcon/delete_15.275362318841px_1143794_easyicon.net.png"></li>删&nbsp;除
			</button>
		</div>
	</div>
	...
	<!-- 模板js -->
	<script src="js/pages/plan/score-upload.js"></script>
