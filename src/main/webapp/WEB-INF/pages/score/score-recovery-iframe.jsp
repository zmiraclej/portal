...
<html>
<head>
<title id="Description">成绩恢复</title>
...
<body>
	...
	<div id="score-input-win" class="easyui-dialog" style="padding:5px;width:1000px;height:600px;"
	...
	<div id="view-score-input-win" class="easyui-dialog" style="padding:5px;width:750px;height:600px;"
	...
	<div id="send-score-input-win" class="easyui-dialog" style="padding:5px;width:400px;height:250px;"
	...
	<script src="${ctx }/js/pages/score/score-recovery.js"></script> 
