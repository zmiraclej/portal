...
<div id="studentAddContent" style="display:none;width:100%;height:90%">
	<form class="layui-form" action="">
	  ...
	  <!-- <div class="layui-form-item" style="margin-top:10px">
	    <label class="layui-form-label"  style="width:120px">校区学部:</label>
	    <div class="layui-input-block">
	...
	<div class="layui-form-item" style="margin-top:10px">
	    <div class="layui-inline">
	      ...
	      <div class="layui-input-inline">
	        <input id="newCardNo" type="text" name="cardNo" lay-verify="phone" autocomplete="off" placeholder="请输入一卡通卡号" class="layui-input" style="width:200px">
	      </div>
	    </div>
	    <div class="layui-inline">
	      <label class="layui-form-label" style="width:120px">一卡通颜色:</label>
	      <div class="layui-input-inline"  style="width:200px">
	          <select name="cardColor" lay-filter="aihao">
