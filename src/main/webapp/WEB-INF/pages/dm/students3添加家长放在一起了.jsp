...
<div id="studentAddContent" style="display:none;width:100%;height:90%">
	<form class="layui-form" action="" method="post" name="formDemo">
	  ...
	  <div class="layui-form-item" style="margin-top:10px">
	    <div class="layui-inline">
	      ...
	      <div class="layui-input-inline">
	        <input id="newIdCardNumber" type="text" name="idCardNumber" lay-verify="idCardNumber" autocomplete="off" placeholder="请输入身份证号" class="layui-input" style="width:200px">
	      </div>
	    </div>
	    <div class="layui-inline">
	   ...
	   <div class="layui-form-item"  style="margin-top:10px">
	    ...
	    <div class="layui-input-inline" style="width:200px;">
	      <select name="schoolCode">
	        ...
	        <option value="浙江">都江堰校区小学部</option>
	        <option value="你的工号">江西省</option>
	        <option value="你最喜欢的老师">福建省</option>
	      </select>
	    </div>
	    <div class="layui-input-inline" style="width:116px">
	      <select name="cureentSchoolCode">
	        <option value="-1">请选择学段</option>
	        <option value="杭州">小学</option>
	        <option value="宁波" disabled="">初中</option>
	        <option value="温州">高中</option>
	      </select>
	    </div>
	    <div class="layui-input-inline"  style="width:116px">
	      <select name="gradeNo">
	...
	<div class="layui-form-item" style="margin-top:10px">
	 ...
	 <div class="layui-tab" style="margin-left:30px;">
		  <ul class="layui-tab-title">
		    <li class="layui-this">家长信息</li>
		  </ul>
		  <div style="margin-top: -40px;margin-right:141px;float:right;"><button class="layui-btn layui-btn-normal" id="btnAddParent">添加</button></div>
		  <div class="layui-tab-content">
		    <div class="layui-tab-item layui-show">
		    	<div class="layui-form-item"  style="margin-top:10px">
				    <div class="layui-input-inline" style="width:200px;">
				     <input type="text" lay-verify="idCardNumber" autocomplete="off" placeholder="请输入家长姓名" class="layui-input" style="width:200px">
				    </div>
				    <div class="layui-input-inline" style="width:116px">
				      <select>
				    ...
				    <div class="layui-input-inline"  style="width:200px">
				      <input type="text" lay-verify="idCardNumber" autocomplete="off" placeholder="请输入家长手机号" class="layui-input" style="width:200px">
				    </div>
