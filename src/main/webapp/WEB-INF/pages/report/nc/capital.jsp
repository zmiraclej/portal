	...
	<div class="content-wrapper">
	    ...
	    <section class="content-header">
            <ul class="breadcrumb">
				...
				<li><a href="#">资金分析</a> <span class="divider"></span></li>
			</ul>
        </section>
	    <!-- 中间部分-top     end -->
	    ...
	    <div class="content">
			<!-- 图表1 -->
					<div id="groupIncomeExpenditure" class="chartArea">
						 <div class="chart_title" style="padding:10px"><span id="chartTitle"></span></div>
						...
						<div id="container" style="height: 300px; width: 100%; margin-top:0px">
							<div id="containerCapital" style="height: 85%; width: 100%"></div>
						</div>
					</div>
				</div>
	    <!-- 中间部分-main     end -->
