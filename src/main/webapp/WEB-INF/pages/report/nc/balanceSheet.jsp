	...
	<div class="content-wrapper">
	    ...
	    <section class="content-header">
            <ul class="breadcrumb">
				...
				<li><a href="#">资产负债分析</a> <span class="divider"></span></li>
			</ul>
        </section>
	    <!-- 中间部分-top     end -->
	    ...
	    <div class="content">
			...
			<div id="groupIncomeExpenditure" class="chartArea">
				...
				<div id="containerFinanceFee" style="height: 400px; width: 100%; margin-top:15px"></div>
			</div>
		</div>
	    <!-- 中间部分-main     end -->
    </div>
...
<script src="js/pages/report/nc/balanceSheet_demo.js"></script>
