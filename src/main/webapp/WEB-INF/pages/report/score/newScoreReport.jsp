...
<html>
	...
	<body class="hold-transition skin-blue-light sidebar-mini">
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<ul class="breadcrumb">
						...
						<li><a href="#">学生学习</a> <span class="divider"></span></li>
				...
				<div class="content">
					<!-- 版块导航 -->
					<ul class="layui-nav" style="background: #fbfbfb; height: 60px; color: #7b6a6a" lay-filter="demo" id="bankuai">
					</ul>
					<!-- 版块导航 -->
					<section class="content-header">
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-inline" style="display:none">
									<!--<select id="reportType" lay-filter="reportType" style="height: 100%; width: 180px">
										<option value="301">均分统计</option>
										<option value="302">分段统计</option>
										<option value="303">学生成绩分析表</option>
									</select>-->
								...
								<div class="layui-input-inline" style="width: 350px;">
									<select id="examIns" lay-filter="examIns" style="height: 100%;">
									</select>
								</div>
		...
		<script src="js/pages/report/score/newScoreReportEchart.js"></script>
		<script src="js/pages/report/score/newScoreReport.js"></script>
		<script>
		</script>
	</body>
