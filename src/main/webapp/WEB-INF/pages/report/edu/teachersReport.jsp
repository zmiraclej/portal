...
<body class="hold-transition skin-blue-light sidebar-mini">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<ul class="breadcrumb">
					...
					<li><a href="#">教师数据统计</a> <span class="divider"></span></li>
				</ul>
			</section>
			<!-- 中间部分-top     end -->
			...
			<!-- 图表1 -->
					<div id="charts-container" class="chartArea">
						 <div class="chart_title"><span>教师数据统计分析</span></div>
			...
			<form class="layui-form" action="">
			   <div class="layui-form-item">
				    ...
				    <div class="layui-input-block">
				      <input type="radio" name="sex" value="1" title="年级">
				      <input type="radio" name="sex" value="1" title="科目/类型"  checked="">
				       <input type="radio" name="sex" value="3" title="教师等级">
				    </div>
				    <div class="layui-input-block">
				      <input type="radio" name="sex" value="3" title="年龄段">
				      <input type="radio" name="sex" value="3" title="司龄段">
				      <input type="radio" name="sex" value="3" title="性别">
				    </div>
			  </div>
	...
	<script src="js/pages/report/edu/teachersReport.js"></script>
</body>
</html>