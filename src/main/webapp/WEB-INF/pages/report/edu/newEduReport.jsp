...
<html>
	...
	<body class="hold-transition skin-blue-light sidebar-mini">
			...
			<div class="content-wrapper">
				...
				<section class="content-header">
					<ul class="breadcrumb">
						...
						<li><a href="#">教学校验</a> <span class="divider"></span></li>
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-inline" style="display:none">
									<!--<select id="reportType" lay-filter="reportType" style="height: 100%; width: 180px">
										<option value="401">师生数量统计</option>
										<option value="402">教师数量统计</option>
										<option value="403">学生数据统计</option>
										<option value="404">学生考勤情况表</option>
									</select>-->
		...
		<script src="js/pages/report/edu/newEduReportEchart.js"></script>
		<script src="js/pages/report/edu/newEduReport.js"></script>
		<script>
		</script>
	</body>
