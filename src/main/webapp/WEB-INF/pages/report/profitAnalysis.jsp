...
<body class="hold-transition skin-blue-light sidebar-mini">
	<div class="wrapper">
		...
		<div class="content-wrapper" style="background-color: white">
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">盈利能力汇总</a> <span class="divider"></span></li>
			</ul>
			</section>
			<!-- 中间部分-top     end -->
			...
			<div class="page-content">
				<div id='mainTable' style="text-align: center;">
					<div id="treeGrid"></div>
					<div id="piscDiv" style="position: absolute;left: 50%;top: 50%;width: 400px;height: 100px;">
	...
	<script type="text/javascript" src="js/pages/report/profitAnalysis.js"></script>
