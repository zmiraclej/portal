		...
		<!-- 中间部分-top     startup -->
        	<section class="content-header">
               <ul class="breadcrumb">
					...
					<li><a href="#">生源地分析</a> <span class="divider"></span></li>
				</ul>
        	</section>
		<!-- 中间部分-top     end -->
		...
		<!-- 中间部分-main     startup -->
           <div class="page-content">
                 <div class="row" style="width: 100%; height: 100%; !important;margin:10px;background-color:white" >
					<div class="chart_title"><span>${schoolName} - 生源地统计</span></div>
					<div class="btn_container" style="margin-top: 20px;margin-left:20px">
							...
							<label>年份</label>
							<select style="height:34px;width:180px;" id="year">
						...
						<%-- 	<label>报名起始日期</label>
							...
							<input type="date" style="height: 34px;width:150px;" class="Wdate"
         						  ...
         						  onFocus="WdatePicker({lang:'zh-cn',readOnly:true,maxDate:new Date(),isShowClear:false})"/> --%>
							<a class="btn btn-primary" id="btn"><i class="fa fa-search"></i>&nbsp;查&nbsp;&nbsp;询</a>					
					</div>
						
					<div id="containerEnrol-div" style="height:500px;">	
						<div id="containerSourcePlace" style="height: 100%; width: 100%"></div>	
					</div>
			</div>
		</div>
    </div>
...
<script type="text/javascript" src="js/pages/report/sourcePlace.js"></script>
