...
<html>
	...
	<body class="hold-transition skin-blue-light sidebar-mini">
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-inline" style="display:none">
									<!--<select id="reportType" lay-filter="reportType" style="height: 100%; width: 180px">
										<option value="201">历年报名数据分析</option>
										<option value="202">录取数据分析</option>
										<option value="203">招生类别分析</option>
										<option value="205">招生情况表</option>
										<option value="204">生源地分析</option>
									</select>-->
								...
								<div class="layui-input-inline">
									<select id="schedule" lay-filter="schedule" style="height: 100%; width: 80px">
		...
		<script src="js/pages/report/zs/newZsReportEchart.js"></script>
		<script src="js/pages/report/zs/newZsReport.js"></script>
		<script>
		</script>
	</body>
