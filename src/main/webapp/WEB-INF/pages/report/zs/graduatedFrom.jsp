		...
		<!-- 中间部分-top     startup -->
        	<section class="content-header">
               <ul class="breadcrumb">
					...
					<li><a href="#">新生毕业院校分析</a> <span class="divider"></span></li>
				</ul>
        	</section>
		<!-- 中间部分-top     end -->
		...
		<div class="content">
			<div class="charts-container">
					<div class="btn_container" style="margin-right: 10px;">
						<select id="year" class="divWidth_fix">
...
<script type="text/javascript" src="js/pages/report/graduatedFrom.js"></script>
