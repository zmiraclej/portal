...
// 加载DOM，并且返回按钮
var dom1 = document.getElementById("containerSex"); // dom加载容器
var myChart1 = echarts.init(dom1); // 初始化容器
var option1 = drillDown1.getOption();
drillDown1.initChart(myChart1, option1);
