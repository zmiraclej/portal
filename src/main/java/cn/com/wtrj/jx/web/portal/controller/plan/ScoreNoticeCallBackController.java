...
import cn.com.wtrj.jx.web.portal.controller.request.SmsNotifyParam;
...
public class ScoreNoticeCallBackController extends BaseController {

	private Logger logger = Logger.getLogger(ScoreNoticeCallBackController.class);
